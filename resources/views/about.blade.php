...
@section('content')
    ...
    <div class="container-fluid">
        <div class="content">
            ...
            <div class="about">
                <p>SeqTrack is designed to capture, validate and store information to generate the control source file for
                ...
                <p>Groups of compatible I5 and I7 indexes</p>
                <br/>
                <br/>
                <h2>System Rules</h2>
                ...
                <h3>Batch</h3>
                <ul>
                    <li>All samples in batch must use same Index Set</li>
                    <li>Use of I5 index is optional</li>
                    <li>If a I5 Index is used, a I5 index must be used for all samples in the batch</li>
                    <li>The I5 and I7 Index combination pair must be unique in a batch</li>
                ...
                <ul>
                    ...
                    <li>Use of I5 index is optional</li>
                    <li>If an I5 Index is used, one must be used for all samples in Run</li>
                    <li>The I5 and I7 Index combination pair for each sample must be unique in Run</li>
                    <li>If I5 indexes are not used each I7 index can only be use once in Batch.</li>
                </ul>
